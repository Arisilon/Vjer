...
- Fix publishing modules with hyphen in name. (GitHub #47)
...
- Add changelog automation. (GitHub #44)

### Changed

- Use update-changelog in python-cicd. (GitHub #44)
- Fix formatting on legacy entries. (GitHub #44)

## [40.0.0] - 2026-05-25

### Added

- Add release_tag option to tag_source action. (GitHub #42)
- Added unit tests. (GitHub #40)
- Add config read/write test. (GitHub #40)
...
- Fixed increment_version for version_service vjer. (GitHub #41)
- Fix lint errors in unit tests. (GitHub #40)
- Finish config tests. (GitHub #40)
- Fix lint errors in integration test suite. (GitHub #40)
- Fix lint errors in tests. (GitHub #40)
- Fix imports. (GitHub #40)
- Fix lint errors and formats. (GitHub #40)
- Finish unit test cleanup. GitHub #40)
- Test fixed workflow.
- Fix vjer step name.
- Update rc num to test pre-release.
...
- Add PyPi username and password.
- Add git commit flag on pre_release.
- Add PyPi pusblish token.
- Add skip of PyPi test.
- Add Vjer RC publish config.

### Changed

- Use bumpver current_version instead of pep440_version. (GitHub #30)
- Fix pre_release image tagging. (GitHub #31)
- Fix bumpver version handling.
- Merge remote-tracking branch 'refs/remotes/origin/main'
- Build with test BatCave.
- Use released workflows.
- Use test workflow.
- Try new action.
- Test new workflow.
- Test re-usable workflow.
- Test with debugging output.
- Try test action.
- Try action with script.
- Use remote action.
- Use workflow.
- Fix workflow usage.
- Fix workflow call.
- Test inputs.
- Test new vjer action.
- Pass in secrets.
- Use new workflow.
- Install test BatCave from test PyPi.
- Allow pre_publish on feature.
- Fix twine settings.
- Pass the artifacts directory to twine.
- Must pass directory as a string.
- Fix twice upload package specification.
- Fix lint error.
- Fix permissions.
- Fix vjer config.
- Merge pull request #33 from Arisilon/feature/pypi-support
- Pass in release token.
- Update version.
- Use latest BatCave.
- Merge pull request #34 from Arisilon/feature/cicd-workflow
- Fix version.
- Fix project name.
- Fix input usage.
- Use vjer-local.
- Fix version number.
- Reset pre-release version.
- Use test BatCave.
- Use new BatCave test module.
- Fix image tagging. (GitHub #31)
- Fix GitHub release creation.
- Create version to release BatCave.
- Allow any version.
- Output project info at start of run.
...
- Update keywords.
- Fix setuptools test.
- Use workflow test branch.
- Ignore tmp dir removal warning.
- Fix build.
- Use released workflow.
- Merge remote-tracking branch 'refs/remotes/origin/main'
- Update the change log.
...
- Merge pull request #25 from Arisilon/jeff/migrate-repo
- Used released tag for workflow actions.
- Fixup line endings.
- Update shared workflow version.
- Need to use local vjer on release.
- Needed to revert version to pre-release.
...
- Update workflows.
- Merge pull request #23 from tardis4500/feature/python-3.12
- Fix rc publish on release. (GitHub #21)
...
- Need to test off main.
- Test re-usable workflow.
- Fix re-usable action ref.
- Update re-usable workflow ref.
- Use updated action.
- Use the new vjer acton.
- Use Vjer action for build.
- Need to hardcode python version.
- Use new install-test action.
- Fix test directory.
- Use flit for build.
- Use new publish workflow.
- Increase permissions.
- Pass in run id on publish.
- Fix variable usage.
- Test variable handling.
- Try inherited secrets.
- Use local re-usable workflow.
- Update change log.
- Fix pip upgrade. (GitHub #19)
- Use local vjer.
- Fix argument order.
- Fi pip install command.
...
- Move GitHub Actions into Vjer bootstrap. (GitHub #17)
- Need to install flit to boostrap this build.
- Need to set VJER_ENV.
- Run tests on all OSen.
- Fix Windows test install.
- Fix Windows install testing.
- Final Windows install fix.
- Fix release publish.
- Install vjer not flit.

### Removed

- Remove build script. (GitHub #17)
...
- Fix build script.
- Update change log.
- Make Helm versions lowercase. (GitHub #12)
...
- Added support for multiple Docker tags at build. (GitHub #8)
- Added support for multiple Helm versions at build. (GitHub #8)

### Changed

- Fix new image tagging on build. (GitHub #8)
...
- Add development utilities and update the README.
...
- Added flit build support. (GutHub #2)
- Add pre_release bumpver support. (GitHub #2)
- Add pip-install function.
- Add full release support.
- Add more debugging.

### Changed

- Convert test to user vjer.
- Update release number.
- Use Vjer artifacts directory. (GitHub #2)
- Only run git setup on release.
- Fix job name.
- Run install test directly.
- Fix PyPI publish.
- Needed to rename back to publish.
- Need to setup git on release.
- Start implementing release functions.
- Insert test log messages.
- Merge remote-tracking branch 'refs/remotes/origin/main'
- Fix bumpver usage.
- Update change log.
...
- Remove BatCave restriction.
- Removed implicit release steps. (GitHub #6)
- Remove obsolete code related to default release steps. (GitHub #6)
...
- Add script runner.
- Add missing freeze command.

### Changed

- Initial commit
- Initial Git commit.
- Prefix files and env vars with module name.
- Finish conversion to module.
- Rename to Vjer.
- Improve default handling.
- Update publish for OICD.
- Fix release publish.
- Update the change log.

### Removed

- Remove support for everything but Docker and Helm.
...
<!-- generated by git-cliff -->
[unreleased]: https://github.com/Arisilon/Vjer/compare/40.1.0..HEAD
[40.1.0]: https://github.com/Arisilon/Vjer/compare/40.0.1..40.1.0
[40.0.1]: https://github.com/Arisilon/Vjer/compare/40.0.0..40.0.1
[40.0.0]: https://github.com/Arisilon/Vjer/compare/39.0.3..40.0.0
[39.0.3]: https://github.com/Arisilon/Vjer/compare/39.0.2..39.0.3
[39.0.2]: https://github.com/Arisilon/Vjer/compare/39.0.1..39.0.2
[39.0.1]: https://github.com/Arisilon/Vjer/compare/39.0.0..39.0.1
[39.0.0]: https://github.com/Arisilon/Vjer/compare/v38.0.0..39.0.0
[38.0.0]: https://github.com/Arisilon/Vjer/compare/v37.1.0..v38.0.0
[37.1.0]: https://github.com/Arisilon/Vjer/compare/v37.0.0..v37.1.0
[37.0.0]: https://github.com/Arisilon/Vjer/compare/v36.1.3..v37.0.0
[36.1.3]: https://github.com/Arisilon/Vjer/compare/v36.1.2..v36.1.3
[36.1.2]: https://github.com/Arisilon/Vjer/compare/v36.1.0..v36.1.2
[36.1.0]: https://github.com/Arisilon/Vjer/compare/v36.0.0..v36.1.0
[36.0.0]: https://github.com/Arisilon/Vjer/compare/v35.0.0..v36.0.0
[35.0.0]: https://github.com/Arisilon/Vjer/compare/v34.2.0..v35.0.0
[34.2.0]: https://github.com/Arisilon/Vjer/compare/v34.1.1..v34.2.0
[34.1.1]: https://github.com/Arisilon/Vjer/compare/v34.1.0..v34.1.1
[34.1.0]: https://github.com/Arisilon/Vjer/compare/v34.0.0..v34.1.0
[34.0.0]: https://github.com/Arisilon/Vjer/compare/v33.0.1..v34.0.0
[33.0.1]: https://github.com/Arisilon/Vjer/compare/v33.0.0..v33.0.1
[33.0.0]: https://github.com/Arisilon/Vjer/compare/v32.1.0..v33.0.0
[32.1.0]: https://github.com/Arisilon/Vjer/compare/v32.0.0..v32.1.0
[32.0.0]: https://github.com/Arisilon/Vjer/compare/v31.0.0..v32.0.0
[31.0.0]: https://github.com/Arisilon/Vjer/compare/v30.0.0..v31.0.0
[30.0.0]: https://github.com/Arisilon/Vjer/tree/v30.0.0
