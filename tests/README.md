...
1. Avoid external dependencies (Git, Docker, Helm, etc.)
1. Test error conditions safely
1. Provide deterministic test execution
...
1. Deploy and release module testing
1. Build module testing with various build systems
1. Version management and update testing
1. File operation and artifact management testing
1. Configuration file parsing with various schemas
...
1. Add tests for bug fixes (regression tests)
1. Document complex test setups
1. Follow existing naming conventions
1. Update this documentation for new test modules
"""

<!-- cSpell:ignore getattr syscmd pathlib docstrings pytest -->
